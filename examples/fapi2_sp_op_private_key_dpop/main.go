// Example fapi2_sp_op_private_key_dpop demonstrates the implementation of a FAPI2 Security Profile
// OpenID Provider with private key JWT authentication and DPoP tokens.
package main
