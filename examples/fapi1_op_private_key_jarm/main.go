// Example fapi1_op_private_key_jarm demonstrates the implementation of a FAPI1 Advanced Security Profile
// OpenID Provider with private key JWT authentication and JARM.
package main
