// Example fapi2_sp_op_private_key_mtls demonstrates the implementation of a FAPI2 Security Profile
// OpenID Provider with private key JWT authentication and sender constrained tokens using TLS certificates.
package main
